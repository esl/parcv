...
static ErlNifResourceType* bytep_res = NULL;

static void 
bytep_cleanup(ErlNifEnv* e, void* arg) {
free(arg);
}
...
nif_initialize(ErlNifEnv* e, int argc, const ERL_NIF_TERM argv[]) {
  ...
  initialize("kernels/main.cl");
  return enif_make_atom(e, "ok");
}

static ERL_NIF_TERM
nif_destroy(ErlNifEnv* e, int argc, const ERL_NIF_TERM argv[]) {
  teardown();
  return enif_make_atom(e, "ok");
}
...
static ErlNifFunc nif_funcs[] = {
  {"initialize", 0, nif_initialize},
  {"teardown", 0, nif_teardown},
  {"transform", 3, nif_transform},
  {"read_png", N, nif_read_png},
  {"write_png", 
};
